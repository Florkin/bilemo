...
--
-- Hôte : localhost
-- Généré le : jeu. 17 déc. 2020 à 14:12
...
--
CREATE DATABASE IF NOT EXISTS `bilemo` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `bilemo`;
