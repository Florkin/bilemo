...
let id = $(".file-dropzone").attr('data-product-id')
...
let _actionToDropZone = Routing.generate("ajax_product_img_upload");
let _addInstance = Routing.generate("ajax_product_new");
let _getUploadedImages;
let _removeImage;

if (typeof (id) != "undefined") {
    _actionToDropZone = Routing.generate("ajax_product_img_upload", {id: id});
    _getUploadedImages = Routing.generate("ajax_get_uploaded_images", {id: id});
    _removeImage = Routing.generate("ajax_remove_image", {id: id});
}
        ...
        if (typeof (id) != "undefined") {
            ...
            $("form[name='product']").on("submit", function (e) {
                ...
                myDropzone.on('queuecomplete', function (file) {
                    window.location.href = Routing.generate("manage_product_index");
                })
            })
        }
    },
